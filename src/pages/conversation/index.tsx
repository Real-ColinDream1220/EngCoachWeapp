  ...
  loadExerciseData = async (exerciseId: string) => {
    try {
      ...
      if (exerciseDetail) {
        ...
        // 从练习详情中提取背景图（优先使用image，其次scenario_image）
        const imageUrl = (exerciseDetail.image || exerciseDetail.scenario_image || '') as string
        
        this.setState({ currentExercise, exerciseImageUrl: imageUrl }, () => {
